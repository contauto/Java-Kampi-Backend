package controleng.northwind.api.controllers;
...
public DataResult<Product> getById(@RequestParam int id) {
    ...
    public DataResult<List<Product>> getByProductNameOrCategory_CategoryId(@RequestParam String productName, Integer categoryId) {
        return this.productService.getByProductNameOrCategory_CategoryId(productName,categoryId);
    }

    @GetMapping("/getByProductNameAndCategoryId")
    public DataResult<Product> getByProductNameAndCategory_CategoryId(@RequestParam String productName, Integer categoryId) {
    ...
    public DataResult<List<Product>> getAll(@RequestParam Integer pageSize,Integer pageNo ) {
